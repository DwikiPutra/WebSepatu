			...
			<div class="row s_product_inner">
				<div class="col-lg-6">
					<div class="s_Product_carousel">
						<div class="single-prd-item">
							<img class="img-fluid" src="<?php echo base_url();?>assets/img/category/<?php echo $product->gambar;?>-p1.jpg" alt="">
						</div>
						<div class="single-prd-item">
							<img class="img-fluid" src="<?php echo base_url();?>assets/img/category//<?php echo $product->gambar;?>-p2.jpg" alt="">
						</div>
						<div class="single-prd-item">
							<img class="img-fluid" src="<?php echo base_url();?>assets/img/category//<?php echo $product->gambar;?>-p3.jpg" alt="">
						</div>
					</div>
				</div>
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						...
						<h2>$<?php echo $product->harga; ?></h2>
						<ul class="list">
							<li><a class="active" href="#"><span>Category</span> : <?php echo $product->brand; ?></a></li>
						...
						<div class="col-lg-6">
							...
							<div class="review_list">
								<div class="review_item">
									<div class="media">
										<div class="d-flex">
											<img src="<?php echo base_url();?>assets/img/product/review-1.png" alt="">
										</div>
										<div class="media-body">
											<h4>Blake Ruiz</h4>
											<i class="fa fa-star"></i>
								...
								<div class="review_item">
									<div class="media">
										<div class="d-flex">
											<img src="<?php echo base_url();?>assets/img/product/review-2.png" alt="">
										</div>
										<div class="media-body">
											<h4>John Krunz</h4>
											<i class="fa fa-star"></i>
								...
								<div class="review_item">
									<div class="media">
										<div class="d-flex">
											<img src="<?php echo base_url();?>assets/img/product/review-3.png" alt="">
										</div>
										<div class="media-body">
											<h4>Stev Josh</h4>
											<i class="fa fa-star"></i>
